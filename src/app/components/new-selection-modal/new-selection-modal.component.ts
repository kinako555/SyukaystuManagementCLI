  ...
  private createCompany(): boolean{
    this.companyHttpService.create(this.company)
      .subscribe((value :any) =>{ 
        ...
        return this.selectionSubject.next(this.company);
      },
      error => {
        console.log('error: ', error);
        return false;
      });
      return true; //ここにはこない TODO やりかた検討
  }

  // selection作成
  private createSelection(): boolean{
